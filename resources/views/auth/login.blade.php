...
<div class="login-container">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="form-options">
            <label class="inline-flex items-center" style="display:flex; align-items:center; gap:8px; cursor:pointer;">
                <input id="remember_me" type="checkbox" name="remember" style="accent-color:#667eea;">
