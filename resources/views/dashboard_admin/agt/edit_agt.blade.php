...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li>
			<a href="{{ route('admin.agt.index') }}">Data Anggota</a>
		</li>
...
<section class="content">
	<div class="box box-primary">
		...
		<form action="{{ route('admin.agt.update', $anggota->nis) }}" method="POST">
			@csrf
			@method('PUT')
			...
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" name="noidentitas"
								...
								value="{{ old('noidentitas', $anggota->noidentitas) }}" required>
							@error('noidentitas')
								<small class="text-danger">{{ $message }}</small>
							@enderror
						</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input type="text" name="notlp"
								...
								value="{{ old('notlp', $anggota->notlp) }}" required>
							@error('notlp')
								<small class="text-danger">{{ $message }}</small>
							@enderror
						</div>
				...
				<div class="alert alert-info">
					...
					{{ $anggota->created_at 
						? $anggota->created_at->translatedFormat('d F Y, H:i') 
						: '-' }} WIB
				</div>
			...
			<div class="box-footer">
				<a href="{{ route('admin.agt.index') }}" class="btn btn-default">
